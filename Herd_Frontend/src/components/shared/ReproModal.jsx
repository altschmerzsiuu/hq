...
export default function ReproModal({ isOpen, onClose, isWidgetMode = false, onBack }) {
  ...
  const contentClass = isWidgetMode
    ? "fixed bottom-[190px] md:bottom-[84px] right-4 md:right-6 w-[360px] h-auto max-h-[540px] max-w-[calc(100vw-32px)] z-[200] animate-in slide-in-from-bottom-8 fade-in duration-300 bg-[var(--bg-surface)] border border-[var(--border)] rounded-[24px] shadow-[var(--shadow-modal)] pointer-events-auto overflow-x-hidden overflow-y-auto no-scrollbar"
