...
export default function Settings() {
  ...
  return (
    <>
    <div className="md:fixed md:inset-0 md:z-[100] md:flex md:items-center md:justify-center md:bg-black/50 md:backdrop-blur-sm animate-in fade-in duration-500 pb-24 px-0 md:p-4" style={{ paddingTop: 'calc(env(safe-area-inset-top) + 56px)' }}>
